...
export default function DateTimeAddressesCard() {
  ...
  return (
    <Card>
      <CardHeader
        className={`${statusColors[status]} relative m-2 flex flex-row items-center justify-between space-y-0 rounded-xl p-4 py-[1.3rem]`}
      >
        <div className="absolute left-4">
          <CardTitle className="font-bold tracking-wide text-white">
            Request #{id}
          </CardTitle>
        ...
        <p className="flex-1 text-right text-xl font-bold tracking-wide text-white lg:text-center lg:text-2xl">
          {status}
        </p>
      </CardHeader>
