  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:opacity-50 disabled:cursor-not-allowed",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-input bg-background shadow-sm hover:bg-accent text-slate-700 hover:text-accent-foreground",
        edit: "border border-input bg-background shadow-sm hover:bg-accent text-primary",
        secondary:
      ...
      size: {
        ...
        sm: "rounded-md px-2 py-1 font-normal",
